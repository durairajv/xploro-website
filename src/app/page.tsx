    ...
    <div className="min-h-screen bg-white text-text-primary">
      ...
      <section className="relative pt-20 pb-4 md:pt-24 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-40 right-1/4 w-[600px] h-[600px] bg-brand-50/40 rounded-full blur-[160px]" />
          <div className="absolute top-20 -left-40 w-[500px] h-[500px] bg-brand-50/25 rounded-full blur-[140px]" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full">
          ...
          >
            ...
            {/* Mobile: voice + GMB cards */}
            <div className="lg:hidden grid grid-cols-2 gap-3">
              <Link href="/voice-analytics" className="rounded-xl overflow-hidden border border-zinc-100 bg-white">
          ...
          <motion.div
            ...
            className="mt-4 pb-2 flex items-center justify-center gap-8 md:gap-14"
          >
            {heroStats.map((stat) => (
      ...
      <section id="platform" className="py-20 md:py-28 bg-zinc-50/60">
        <div className="max-w-7xl mx-auto px-6">
      ...
      {/* ─── Value Metrics ─── */}
      <section id="impact" className="py-20 md:py-28 bg-zinc-50/60">
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            <p className="text-brand-500 text-sm font-semibold tracking-wider uppercase mb-3">
              The Impact
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <AnimatedSection delay={0.2} className="mb-20">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white border border-border-default rounded-2xl p-8 hover:border-brand-100 transition-all duration-300">
      ...
      <section
        id="cta"
        className="relative py-20 md:py-28 bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 overflow-hidden"
      >
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          <AnimatedSection>
            ...
            <div className="flex items-center justify-center gap-3 text-sm text-brand-200/60">
              <Check className="w-3.5 h-3.5" /> 30-minute setup
              <span>&bull;</span>
              <Check className="w-3.5 h-3.5" /> No credit card
              <span>&bull;</span>
              <Check className="w-3.5 h-3.5" /> Free pilot
            </div>
          </AnimatedSection>
        </div>
      </section>
